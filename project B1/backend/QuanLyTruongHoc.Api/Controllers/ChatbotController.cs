...
public class ChatbotController : ControllerBase
{
    ...
    public async Task<ActionResult<ChatbotResponse>> Hoi(ChatbotRequest request)
    {
        ...
        const string systemPrompt =
            ...
            "Nếu trả lời từ DỮ LIỆU HỆ THỐNG hoặc kiến thức chung (không dùng tài liệu), TUYỆT ĐỐI không thêm dòng đó.";
        ...
        string traLoi;
        try { traLoi = await _aiChat.ChatAsync(systemPrompt, messages); }
        catch (Exception ex) { return StatusCode(502, new { message = "Không thể kết nối dịch vụ AI: " + ex.Message }); }
